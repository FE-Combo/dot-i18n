...
function generateLocale() {
    ...
    fs_extra_1.default.ensureDirSync(path_1.default.join(process.cwd(), config === null || config === void 0 ? void 0 : config.localePath));
    fs_extra_1.default.ensureFileSync(path_1.default.join(process.cwd(), (config === null || config === void 0 ? void 0 : config.localePath) + "/index.ts"));
    ...
    languages.forEach(function (_) {
        fs_extra_1.default.ensureFileSync(path_1.default.join(process.cwd(), (config === null || config === void 0 ? void 0 : config.localePath) + "/" + _ + ".ts"));
        fs_extra_1.default.writeFileSync(path_1.default.join(process.cwd(), (config === null || config === void 0 ? void 0 : config.localePath) + "/" + _ + ".ts"), "export default " + JSON.stringify(result[_]));
        indexTemplate += "import " + _ + " from \"./" + _ + "\";\n";
    });
    indexTemplate += "\nexport default {" + languages.join(", ") + "};\n";
    fs_extra_1.default.writeFileSync(path_1.default.join(process.cwd(), (config === null || config === void 0 ? void 0 : config.localePath) + "/index.ts"), indexTemplate);
}
function execute() {
    var config = i18nStore.getConfig();
    ...
    var localePath = config === null || config === void 0 ? void 0 : config.localePath;
    if (allLocales) {
        result = allLocales;
    }
